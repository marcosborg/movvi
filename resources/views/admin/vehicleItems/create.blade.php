                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicle-items.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('acquisition_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="acquisition_value" id="acquisition_value" value="{{ old('acquisition_value') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('sale_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="sale_value" id="sale_value" value="{{ old('sale_value') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('is_service_vehicle') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="is_service_vehicle" id="is_service_vehicle" value="1" {{ old('is_service_vehicle', 0) == 1 ? 'checked' : '' }}>
