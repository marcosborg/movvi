        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} Utilização da viatura
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicle-usages.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('vehicle_item') ? 'has-error' : '' }}">
                            <label class="required" for="vehicle_item_id">Viatura</label>
                        ...
                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                            <label class="required" for="start_date">Data de início</label>
