                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.drivers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" min="0" step="1" name="weekly_km_limit" id="weekly_km_limit" value="{{ old('weekly_km_limit', 2000) }}" required>
                        </div>
                        <div class="form-group">
                            <label class="required" for="excess_km_rate">Valor por km excedido (€)</label>
                            <input class="form-control" type="number" min="0" step="0.01" name="excess_km_rate" id="excess_km_rate" value="{{ old('excess_km_rate', 0.10) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('bolt_individual_id') ? 'has-error' : '' }}">
                            <label for="bolt_individual_id">{{ trans('cruds.driver.fields.bolt_individual_id') }}</label>
                            <input class="form-control" type="text" name="bolt_individual_id" id="bolt_individual_id" value="{{ old('bolt_individual_id', '') }}">
                            @if($errors->has('bolt_individual_id'))
                                <span class="help-block" role="alert">{{ $errors->first('bolt_individual_id') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.driver.fields.bolt_individual_id_helper') }}</span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('pays_fuel') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="pays_fuel" id="pays_fuel" value="1" {{ old('pays_fuel', 1) ? 'checked' : '' }}>
