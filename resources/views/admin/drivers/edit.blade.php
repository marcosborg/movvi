                    ...
                    <form method="POST" action="{{ route("admin.drivers.update", [$driver->id]) }}"
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email"
                                value="{{ old('email', $driver->effective_email) }}" required>
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('driver_vat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="driver_vat" id="driver_vat"
                                value="{{ old('driver_vat', $driver->driver_vat) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('bolt_individual_id') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bolt_individual_id" id="bolt_individual_id"
                                value="{{ old('bolt_individual_id', $driver->bolt_individual_id) }}">
