<aside class="main-sidebar">
    ...
    @endif
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="{{ request()->is("admin/menu-links") || request()->is("admin/menu-links/*") ? "active" : "" }}">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            @endcan
                            @can('news_article_access')
                            <li class="{{ request()->is("admin/news-articles") || request()->is("admin/news-articles/*") ? "active" : "" }}">
                                <a href="{{ route("admin.news-articles.index") }}">
                                    <i class="fa-fw far fa-newspaper">

                                    </i>
                                    <span>{{ trans('cruds.newsArticle.title') }}</span>
