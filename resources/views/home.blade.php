            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @if(($driver_card_codes ?? collect())->isEmpty() && !$hasOtherFuelTransactions)
                        <div class="alert alert-info">Sem cart�es associados ao motorista.</div>
                    @elseif(!$hasCombustionTransactions && !$hasOtherFuelTransactions)
                        <div class="alert alert-info">
                            ...
                            <br>
                            <small>Cart�es considerados: {{ $driver_card_codes->join(', ') }}</small>
                            @endif
                        </div>
                    @else
                        @if(($driver_card_codes ?? collect())->isNotEmpty())
                        <p><small>Cart�es considerados: {{ $driver_card_codes->join(', ') }}</small></p>
                        @endif
