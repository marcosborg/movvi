...
Route::get('/stand', [WebsiteController::class, 'stand'])->name('website.stand');
Route::get('/stand/{standCar}/{slug?}', [WebsiteController::class, 'standCar'])->name('website.stand.show');
Route::post('/stand/{standCar}/{slug?}/form', [WebsiteController::class, 'submitStandCarForm'])->name('website.stand.form');
Route::get('/aluguer', [WebsiteController::class, 'rentals'])->name('website.rentals');
Route::get('/aluguer/{car}/{slug?}', [WebsiteController::class, 'rentalCar'])->name('website.rentals.show');
Route::post('/aluguer/form', [WebsiteController::class, 'submitRentalContact'])->name('website.rentals.form');
Route::get('/transfers-tours', [WebsiteController::class, 'transfersTours'])->name('website.transfers');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', 'prevent-writes-while-impersonating']], function () {
    ...
    // News Article
    Route::delete('news-articles/destroy', 'NewsArticleController@massDestroy')->name('news-articles.massDestroy');
    Route::post('news-articles/media', 'NewsArticleController@storeMedia')->name('news-articles.storeMedia');
    Route::post('news-articles/ckmedia', 'NewsArticleController@storeCKEditorImages')->name('news-articles.storeCKEditorImages');
    Route::resource('news-articles', 'NewsArticleController');
    ...
    // Website Menu Links
    Route::post('menu-links/order', [\App\Http\Controllers\Admin\MenuLinkController::class, 'order'])->name('menu-links.order');
    Route::resource('menu-links', \App\Http\Controllers\Admin\MenuLinkController::class)->except(['show']);
...
Route::group(['prefix' => 'profile', 'as' => 'profile.', 'namespace' => 'Auth', 'middleware' => ['auth']], function () {
    ...
    if (file_exists(app_path('Http/Controllers/Auth/ChangePasswordController.php'))) {
        ...
        Route::post('password/clear-cache', 'ChangePasswordController@clearCache')->name('password.clear-cache');
