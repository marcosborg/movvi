...
class StandCarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = StandCar::with(['brand', 'car_model', 'fuel', 'catalogYear', 'origin', 'status'])->select(sprintf('%s.*', (new StandCar())->table));
            ...
            $table->addColumn('catalog_year_name', function ($row) {
                return $row->catalogYear ? $row->catalogYear->name : '';
            });
            ...
            $table->rawColumns(['actions', 'placeholder', 'brand', 'car_model', 'fuel', 'catalogYear', 'origin', 'status', 'images']);
    ...
    public function create()
    {
        ...
        return view('admin.standCars.create', compact('brands', 'car_models', 'fuels', 'years', 'origins', 'statuses'));
    }
    ...
    public function edit(StandCar $standCar)
    {
        ...
        $standCar->load('brand', 'car_model', 'fuel', 'catalogYear', 'origin', 'status');

        return view('admin.standCars.edit', compact('brands', 'car_models', 'fuels', 'years', 'origins', 'standCar', 'statuses'));
    }
